...
---
# 0. 참고한 블로그
- [@next/mdx로 블로그 만들기 (App router)](https://www.leehyeonjun.com/blog/next_mdx_blog)
- [Next.js로 블로그 만들기](https://bepyan.github.io/blog/nextjs-blog)
- [NextJS로 블로그를 만들어보자](https://velog.io/@minsang9735/NextJS%EB%A1%9C-%EB%B8%94%EB%A1%9C%EA%B7%B8%EB%A5%BC-%EB%A7%8C%EB%93%A4%EC%96%B4%EB%B3%B4%EC%9E%90#%EC%99%9C-%EB%A7%8C%EB%93%AC)
- [Next.js 블로그 만들기 (14.1 최신 버전 + tailwind)](https://d5br5.dev/blog/nextjs_blog/setup)
...
사용은 className에 `prose`를 추가하면 돼요.
```tsx
<div className="prose">
  <Component />
</div>
...
## 게시 글 페이지
<HoverContainer>
- [generateStaticParams](hover:one) [자세히](https://nextjs.org/docs/app/api-reference/functions/generate-static-params) 
  빌드 시점에 어떤 동적 경로를 미리 생성할지 **Next.js**에 알려 주는 역할을 해요.
...
- [generateMetadata](hover:two) [자세히](https://nextjs.org/docs/app/api-reference/functions/generate-metadata)
  동적 경로에 맞춘 `<head>` 메타데이터를 서버 컴포넌트 차원에서 동적으로 생성하기 위해 사용돼요.
