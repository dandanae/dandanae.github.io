...
export const Project014: Project = {
  ...
  content: (
    <>
      ...
      <h2>PIE EVENT 퀴즈</h2>
      <ul>
        <li>PIE 회사의 JANUS Pro에 대한 퀴즈를 만들어 풀 수 있도록 했어요.</li>
        <li>
          <code>json</code>으로 다국어에 대응할 수 있도록 만들었어요.
        </li>
        <li>응모가 완료되면 수집한 이메일로 응모 번호를 전송해요.</li>
      </ul>
      <h2>전시회 등록 / 관리</h2>
      <ul>
        <li>자주 가는 전시회를 등록하고 관리할 수 있어요.</li>
      </ul>
      <h2>응모 일정 등록 / 관리</h2>
      <ul>
        <li>등록된 전시회를 선택해 기간을 정하면 퀴즈 페이지가 열려요.</li>
      </ul>
      <h2>추첨</h2>
      <ul>
        <li>
      ...
      <h1>💡 제작 중 어려웠던 점</h1>
      <h2>하나의 로드밸런서에 두 개의 도메인</h2>
      <h3 className="bg-secondary/20">🚫 어려웠던 점</h3>
      <ul>
        <li>이벤트 서버는 항상 켜둘 필요가 없어 기존 서버를 함께 사용하기로 했어요.</li>
        <li>
      ...
      <ul>
        ...
        <li>허용 경로 화이트리스트 방식으로 정규식을 단순화하고 성능 저하를 방지했어요.</li>
        <li>
      ...
      <ul>
        ...
        <li>
          웹 표준 가이드라인에 따라 접근 경로를 일관성 있게 유지하는 것이 UX 신뢰성에 직결됨을
          체감했어요.
        </li>
      </ul>

      <h1>🚀 주요 성과 및 효과</h1>
      <h2>전문적 이미지를 넘어, 친근한 참여 기회 제공</h2>
      <ul>
        <li>
          PIE와 JANUS Pro를 기술 중심이 아닌 퀴즈 이벤트 형식으로 풀어내어 사용자 접근 장벽을
          낮췄어요.
        </li>
        <li>
          전문적인 기기라는 인식 때문에 일반 고객 참여가 저조했지만, 이벤트를 통해 가볍게 즐길 수
          있는 분위기를 조성했어요.
        </li>
        <li>응모와 추첨 과정을 통해 고객과 직접적으로 연결되는 경험을 제공했어요.</li>
        <li>
          결과적으로 제품 인지도를 넓히고, 잠재 고객층까지 친근하게 다가가는 접점을 새롭게
          창출했어요.
        </li>
      </ul>
    </>
