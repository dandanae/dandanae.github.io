...
export const Project012: Project = {
  ...
  content: (
    <>
      ...
      <h2>블루투스를 통한 뷰티 디바이스 제어</h2>
      <ul>
        <li>
          한 번 연결한 디바이스는 리스트에 남아 관리할 수 있도록 하였고, 동시에 하나의 디바이스만
          연결할 수 있도록 하여 안정적인 제어를 보장해요.
        </li>
      </ul>
      <h2>미리 정의된 프리셋 모드 + 커스텀 모드 기능</h2>
      <ul>
        <li>
          세 가지 기본 제공 모드 외에도, 사용자가 원하는 시간, 펄스 강도, LED 강도 등을 자유롭게
          설정하여 커스텀 모드를 구성할 수 있도록 했어요.
        </li>
      </ul>
      <h2>이력 자동 저장 및 관리 기능</h2>
      <ul>
        <li>
          모드 실행 시 타이머 시작과 함께 해당 기록이 API를 통해 자동 저장되며, 사용자는 자신의 사용
          이력을 확인하고 관리할 수 있어요.
        </li>
      </ul>
      <h2>이력 기반 재사용 기능</h2>
      <ul>
        <li>
          이력에서 사용한 모드를 선택하면 해당 모드 페이지로 이동해 다시 실행할 수 있으며, 커스텀
          모드 역시 사용 당시의 세부 설정 그대로 실행돼요.
        </li>
      </ul>
      <h2>커스텀 프리셋 모드 기능</h2>
      <ul>
        <li>커스텀 모드를 저장하여 추후 다시 사용할 수 있도록 했어요.</li>
      </ul>
      <h1>💡 제작 중 어려웠던 점</h1>
      <h2>해외 기업과의 협업</h2>
      ...
      <ul>
        <li>
          처음에는 영업팀을 거쳐 일본 측과 소통하다 보니 전달 과정에서 오류가 많았고 일정이
          지연됐어요.
        </li>
      </ul>
      ...
      <ul>
        <li>
          제가 JLPT N1을 가지고 있어서 직접 일본 측과 소통하겠다고 제안했고, 이후부터는 제가 바로
          소통을 맡았어요.
        </li>
        <li>
          개발자가 직접 기능 목적과 구현 방식을 설명하다 보니 요구사항이 명확해지고 피드백 속도도
          빨라졌어요.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          기술적인 설명을 직접 전달하면서 개발자와 클라이언트 사이의 간극을 줄일 수 있다는 자신감을
          얻었어요.
        </li>
      </ul>
      <h2>Flutter의 크로스 플랫폼 지원</h2>
      <h3 className="bg-secondary/20">🚫 어려웠던 점</h3>
      <ul>
        <li>iOS에서는 잘 되는데 Android에서는 권한 문제 등으로 안 되는 경우가 있었어요.</li>
        <li>
      ...
      <ul>
        <li>
          ...
          을 활용해 테스트 범위를 확대했습니다.
        </li>
      </ul>
      <h3 className="bg-secondary/20">🌱 배운 점</h3>
      <ul>
        <li>크로스 플랫폼이라고 해도 OS별 동작 차이를 잘 이해하고 있어야 한다는 걸 배웠어요.</li>
        <li>문제 원인을 분석하고 해결하는 과정에서 문제 해결 능력이 많이 늘었어요.</li>
      </ul>
      <h2>BLE 개발</h2>
      <h3 className="bg-secondary/20">🚫 어려웠던 점</h3>
      <ul>
        ...
        <li>일정 시간이 지나 화면이 꺼지면, 백그라운드에서 커맨드 전송이 되지 않았어요.</li>
      </ul>
      <h3 className="bg-secondary/20">✅ 문제 해결 방법</h3>
      <ul>
        <li>
      ...
      <h1>🚀 주요 성과 및 효과</h1>
      <h2>협업 관계 강화 및 신뢰 구축</h2>
      <ul>
        <li>
          일본 기업과 직접 소통하면서 신뢰를 얻었고, 이후 다른 프로젝트(APL)로 이어질 기회를
          만들었어요.
        </li>
      </ul>
      <h2>브랜드 및 제품 홍보 효과</h2>
      <ul>
        <li>
