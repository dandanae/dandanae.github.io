  ...
  hardTasks: [
    {
      ...
      solutions: [
        <div className="grid grid-cols-2 gap-2">
          <img src="https://dandanae.github.io/images/013-01.gif" />
          <img src="https://dandanae.github.io/images/013-02.gif" />
        </div>,
  ...
  uiPoint: [
    {
      ...
      lists: [
        ...
        <>
          <code>react-hook-form</code> + 스키마 검증으로 단계별 유효성 검사를 통과해야 다음 단계로
          이동하도록 가드했어요.
        </>,
      ],
    },
    ...
    },
    {
      ...
      lists: [
        <>
          <code>react-query</code> 상태에 맞춰 스켈레톤·Empty 가이드·재시도 버튼을 일관된 패턴으로
          제공했어요.
        </>,
      ],
    },
